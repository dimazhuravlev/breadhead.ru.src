  ...
  slides: [
...

    {
      ...
      data: {
        ...
        description: [
          `Мы сторонники гибких методов разработки. Наш процесс похож на концепцию ${(
            <a href="https://ru.wikipedia.org/wiki/Rational_Unified_Process">
              Rational Unified Process
            </a>
          )}: допускаем, что требования к продукту могут меняться в процессе; обеспечиваем тесный контакт команды и клиента; проектируем и тестируем архитектуру на ранних стадиях; используем компоненты в дизайне и разработке.`
        ]
      }
    },
    {
